...
# Notice
This is used for our paper ["DRL-VO: Learning to Navigate Through Crowded Dynamic Scenes Using Velocity Obstacles"](
...
) in IROS 2021, which is modified from [YOLO: Real-Time Object Detection](http://pjreddie.com/darknet/yolo/). 

## Modifications:
* Add position estimation by using point cloud data from the depth camera (e.g. ZED camera);
* Add Rviz visualization of position estimation information;
